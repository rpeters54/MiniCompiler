...
public interface MiniVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitArrayType(MiniParser.ArrayTypeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code LvalueIndex}
	 * labeled alternative in {@link MiniParser#lvalue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLvalueIndex(MiniParser.LvalueIndexContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIndexExpr(MiniParser.IndexExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitNewArrayExpr(MiniParser.NewArrayExprContext ctx);
	/**
